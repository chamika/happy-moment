...
public class HiddenTable extends SQLiteOpenHelper {

	private static final String TAG = "HiddenTable";
	...
	public HiddenTable(Context context) {
	...
	public boolean hidePhoto(String photoId) {
		SQLiteDatabase db = this.getWritableDatabase();

		StringBuilder queryBuilder = new StringBuilder();
		queryBuilder.append("INSERT OR IGNORE INTO `hidden` (`photo_id`) values(?)");
	...
	public boolean removeFromHidden(String photoId) {
		SQLiteDatabase db = this.getWritableDatabase();

		StringBuilder queryBuilder = new StringBuilder();
		queryBuilder.append("DELETE FROM `hidden` WHERE `photo_id` = ?");
